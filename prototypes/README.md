...
cd multi-agent-cybersecurity-redteam-simulation-main
...
### 4. Launch Dashboard (Recommended First Step)
...
### 5. Run Example Usage Script

```bash
# Activate virtual environment
source venv/bin/activate

# Run example usage (interactive menu)
python run_example.py

# OR run directly
python cyber_defense_simulator/example_usage.py
```

### 6. Run Simulation from Command Line
...
# Run 20 episodes
python run_simulation.py --episodes 20

# Run specific attack types
python run_simulation.py --episodes 30 --attack-types phishing lateral_movement

# Enable verbose logging
python run_simulation.py --episodes 20 --verbose
```

### 7. Run from Dashboard

The dashboard has a built-in simulation runner. Just:
1. Open the dashboard
2. Use the sidebar to configure episodes and attack types
