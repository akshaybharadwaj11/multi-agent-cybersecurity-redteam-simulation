    ...
    def detect_incident(
        ...
        try:
            ...
            if hasattr(result, 'raw'):
                ...
                result = str(result.tasks_output[0])
            else:
                result = str(result)
            ...
            if isinstance(result, str):
                ...
                try:
                    ...
                    # If JSON parsing fails, use fallback detection
                    logger.warning("Failed to parse LLM response as JSON. Using fallback detection.")
