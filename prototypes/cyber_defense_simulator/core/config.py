...
class Config:
    ...
    def validate(cls) -> bool:
        ...
        # Only validate API key if it's actually needed (not on import)
        # This allows the config to be imported without .env file
...
# Create directories on import (but don't validate API key until needed)
try:
    Config.validate()
except Exception:
    pass  # Allow import without .env file
